...
class _$_QuoteModel implements _QuoteModel {
  _$_QuoteModel({required this.id, required this.title, required this.author});
  ...
  @override
  String toString() {
    return 'QuoteModel(id: $id, title: $title, author: $author)';
  }
...
abstract class _QuoteModel implements QuoteModel {
  factory _QuoteModel(
      ...
      required final String author}) = _$_QuoteModel;
